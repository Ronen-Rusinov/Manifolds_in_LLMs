...
parser = argparse.ArgumentParser(
	description="Check if overlapping neighborhoods can be rigidly aligned (PCA embeddings)"
)
...
def main():
	result_dir = (
		...
		/ "results"
		/ f"mapping_alignment_pca_{config.clustering.n_centroids}_{config.dimensionality.n_components}_{config.clustering.k_nearest_large}"
	)
	...
	all_embeddings = common.batch_load_pca_embeddings(
